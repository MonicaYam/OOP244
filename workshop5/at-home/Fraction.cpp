...
namespace sict {
	...
	Fraction Fraction::operator*(const Fraction& rhs) const {
		Fraction temp;
		if (isValueContained(rhs)) {
			temp._numerator = _numerator * rhs._numerator;
			temp._denominator = _denominator * rhs._denominator;
			temp.reduce();
		}
		else {
	...
	bool Fraction::operator!=(const Fraction& rhs) const {
		return isValueContained(rhs) &&  ( _numerator != rhs._numerator || _denominator != rhs._denominator);
	}
	...
	bool Fraction::isValueContained(const Fraction& rhs) const {
